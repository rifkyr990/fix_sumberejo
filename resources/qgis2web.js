...
map.getView().fit([12226517.354076, -804928.817446, 12227016.741356, -804611.492645], map.getSize());
    ...
    for (var i = 0; i < currentFeatureKeys.length; i++) {
        if (currentFeatureKeys[i] != 'geometry') {
            ...
            if (layer.get('fieldImages')[currentFeatureKeys[i]] != "ExternalResource") {
                ...
                popupField += (currentFeature.get(currentFeatureKeys[i]) != null ? '<img style="width: 125px;" src="' + currentFeature.get(currentFeatureKeys[i]) + '" /></td>' : '');
            }
